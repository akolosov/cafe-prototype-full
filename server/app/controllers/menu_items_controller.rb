class MenuItemsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @menu_item.save
        format.html { redirect_to menu_item_url(@menu_item.menu, @menu_item), notice: 'Menu item was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @menu_item.update_attributes(params[:menu_item])
        format.html { redirect_to menu_item_url(@menu_item.menu, @menu_item), notice: 'Menu item was successfully updated.' }
        format.json { head :ok }
        format.xml  { head :ok }
      else
